import { Minipass } from '../../../minipass/dist/esm/index.js';
import { Path } from '../../../path-scurry/dist/esm/index.js';
...
export { escape, unescape } from '../../node_modules/minimatch/dist/esm/index.js';
export type { FSOption, Path, WalkOptions, WalkOptionsWithFileTypesTrue, WalkOptionsWithFileTypesUnset, } from '../../../path-scurry/dist/esm/index.js';
...
export declare const glob: typeof glob_ & {
    ...
    escape: (s: string, { windowsPathsNoEscape, }?: Pick<import("../../node_modules/minimatch/dist/esm/index.js").MinimatchOptions, "windowsPathsNoEscape">) => string;
    unescape: (s: string, { windowsPathsNoEscape, }?: Pick<import("../../node_modules/minimatch/dist/esm/index.js").MinimatchOptions, "windowsPathsNoEscape">) => string;
};

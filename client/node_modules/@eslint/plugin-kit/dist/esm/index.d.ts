export type VisitTraversalStep = import("@eslint/plugin-kit/node_modules/@eslint/core").VisitTraversalStep;
export type CallTraversalStep = import("@eslint/plugin-kit/node_modules/@eslint/core").CallTraversalStep;
export type TraversalStep = import("@eslint/plugin-kit/node_modules/@eslint/core").TraversalStep;
export type SourceLocation = import("@eslint/plugin-kit/node_modules/@eslint/core").SourceLocation;
export type SourceLocationWithOffset = import("@eslint/plugin-kit/node_modules/@eslint/core").SourceLocationWithOffset;
export type SourceRange = import("@eslint/plugin-kit/node_modules/@eslint/core").SourceRange;
export type IDirective = import("@eslint/plugin-kit/node_modules/@eslint/core").Directive;
export type DirectiveType = import("@eslint/plugin-kit/node_modules/@eslint/core").DirectiveType;
export type SourceCodeBaseTypeOptions = import("@eslint/plugin-kit/node_modules/@eslint/core").SourceCodeBaseTypeOptions;
/**
 * <Options>
 */
export type TextSourceCode<Options extends SourceCodeBaseTypeOptions = import("@eslint/plugin-kit/node_modules/@eslint/core").SourceCodeBaseTypeOptions> = import("@eslint/plugin-kit/node_modules/@eslint/core").TextSourceCode<Options>;
export type RuleConfig = import("@eslint/plugin-kit/node_modules/@eslint/core").RuleConfig;
export type RulesConfig = import("@eslint/plugin-kit/node_modules/@eslint/core").RulesConfig;
...
} = import("@eslint/plugin-kit/node_modules/@eslint/core").SourceCodeBaseTypeOptions & {
    SyntaxElementWithLoc: object;
}> implements TextSourceCode<Options> {
    /**
     * Creates a new instance.
